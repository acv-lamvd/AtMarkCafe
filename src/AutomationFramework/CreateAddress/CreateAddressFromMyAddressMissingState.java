...
public class CreateAddressFromMyAddressMissingState {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingState() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech5");
		Thread.sleep(2000);
