...
public class CreateAddressFromCartMissingCity {
	public WebDriver driver;
  @Test
  public void createAddressFromCartMissingCity() throws InterruptedException {
	  driver.findElement(By.className("icon-shopping-cart")).click();
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet1");
		Thread.sleep(2000);
		...
		WebElement errorCity = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorCity.getText().equals("市区町村必須です")){	
			System.out.println("Test case check missing City PASSED!");
			System.out.println("========================");
		}else{
			System.out.println("FAILED! Test case check missing City is Failed!");
			System.out.println("========================");
		}
  }
  @BeforeMethod
