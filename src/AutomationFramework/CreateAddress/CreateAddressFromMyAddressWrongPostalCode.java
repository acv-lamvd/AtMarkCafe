...
public class CreateAddressFromMyAddressWrongPostalCode {
	public WebDriver driver;
  @Test
  public void createAddressFromMyAddressWrongPostalCode() throws InterruptedException {
	  WebDriverWait wait = new WebDriverWait(driver, 5000);
		...
		driver.findElement(By.id("alias")).sendKeys("Cech7");
		Thread.sleep(2000);
		...
		driver.findElement(By.id("postcode")).sendKeys("1233-6567000");
		Thread.sleep(2000);
