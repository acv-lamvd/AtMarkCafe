...
public class CreateAddressFromMyAddressMissingTelephone {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingTelephone() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech6");
		Thread.sleep(2000);
