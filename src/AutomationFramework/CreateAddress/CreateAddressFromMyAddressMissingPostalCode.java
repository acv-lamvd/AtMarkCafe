...
public class CreateAddressFromMyAddressMissingPostalCode {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingPostalCode() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech4");
		Thread.sleep(2000);
