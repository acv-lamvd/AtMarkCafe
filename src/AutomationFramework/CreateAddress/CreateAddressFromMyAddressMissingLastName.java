...
public class CreateAddressFromMyAddressMissingLastName {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingLastName() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech3");
		Thread.sleep(2000);
