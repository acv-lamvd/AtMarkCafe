...
public class CreateAddressFromCartMissingState {
	public WebDriver driver;

	@Test
	public void createAddressFromCartMissingState() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet5");
		Thread.sleep(2000);
		...
		WebElement errorState = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li[1]"));
		if (errorState.getText().equals("都道府県 必須です")) {
			System.out.println("Test case check missing state is PASSED!");
			System.out.println("=================");
		} else {
			System.out.println("FAILED! Test case check missing state is Failed");
			System.out.println("=================");
		}
	}
