...
public class CreateAddressFromCartWrongTelephone {
	public WebDriver driver;

	@Test
	public void createAddressFromCartWrongTelephone() throws InterruptedException {
		...
		driver.findElement(By.id("phone")).sendKeys("0123456789dfas");
		Thread.sleep(2000);
