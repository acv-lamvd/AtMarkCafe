...
public class CreateAddressFromMyAddressMissingFirstName {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingFirstName() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech2");
		Thread.sleep(2000);
