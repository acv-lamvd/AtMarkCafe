...
public class CreateAddressFromCartMissingLastName {
	public WebDriver driver;
  @Test
  public void createAddressFromCartMissingLastName() throws InterruptedException {
	  driver.findElement(By.className("icon-shopping-cart")).click();
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet3");
		Thread.sleep(2000);
		...
		WebElement errorLastname = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorLastname.getText().equals("姓 必須です")){
			System.out.println("Test case check missing Last name is PASSED");
			System.out.println("=================");
		}else{
			System.out.println("FAILED! Test case check missing Last name is Failed!");
			System.out.println("=================");
		}
  }
  @BeforeMethod
