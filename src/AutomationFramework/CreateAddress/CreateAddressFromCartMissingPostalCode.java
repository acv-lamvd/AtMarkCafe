...
public class CreateAddressFromCartMissingPostalCode {
	public WebDriver driver;

	@Test
	public void createAddressFromCartMissingPostalCode() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet4");
		Thread.sleep(2000);
		...
		if (errorPostalCode.getText().equals("郵便番号は無効です。次のとおりに入力しなければなりません：000-0000")) {
			System.out.println("Test case check missing Postal code is PASSED!");
			System.out.println("=================");
		} else {
			System.out.println("FAILED! Test case check missing Postal code is Failed");
			System.out.println("=================");
		}
	}
