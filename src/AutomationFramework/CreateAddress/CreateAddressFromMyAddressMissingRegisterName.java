...
public class CreateAddressFromMyAddressMissingRegisterName {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingRegisterName() throws InterruptedException {
		...
		WebElement errorRegistername = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorRegistername.getText().equals("アドレス名 必須です")){
			System.out.println("Test case check missing Register Address Name is PASSED!");
			System.out.println("===================");
		}else{
			System.out.println("FAILED! Test case check missing Register Address Name is Failed!");
			System.out.println("===================");
		}
	}
