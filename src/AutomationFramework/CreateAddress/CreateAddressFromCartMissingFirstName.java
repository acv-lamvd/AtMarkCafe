...
public class CreateAddressFromCartMissingFirstName {
	public WebDriver driver;
  @Test
  public void createAddressFromCartMissingFirstName() throws InterruptedException {
	  driver.findElement(By.className("icon-shopping-cart")).click();
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet2");
		Thread.sleep(2000);
		...
		WebElement errorFirstname = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorFirstname.getText().equals("名 必須です")){
			System.out.println("Test case check missing First name is PASSED");
			System.out.println("================");
		}else{
			System.out.println("FAILED! Test case check missing First name is FAILED");
			System.out.println("================");
		}
  }
  @BeforeMethod
