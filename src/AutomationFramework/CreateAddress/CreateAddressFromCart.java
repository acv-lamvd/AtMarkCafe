...
public class CreateAddressFromCart {

	public WebDriver driver;

	@Test
	public void createAddressFromCart() throws InterruptedException {
		...
		if (driver.findElement(By.xpath(".//*[@id='center_column']/h1")).isDisplayed()) {
			System.out.println("Create new address successfully");
			System.out.println("=================================");
		} else {
			System.out.println("FAILED!!! Could not create new address!");
			System.out.println("=================================");
		}
	}
