...
public class CreateAddressFromMyAddressSameRegName {
	public WebDriver driver;
  @Test
  public void createAddressFromMyAddressSameRegName() throws InterruptedException {
	  WebDriverWait wait = new WebDriverWait(driver, 5000);
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Cau4");
		Thread.sleep(2000);
		...
		WebElement errorExistedName = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorExistedName.getText().contains("他のものを選択してください。")){
			System.out.println("Test case check create duplicate user is PASSED!");
			System.out.println("====================");
		}else{
			System.out.println("FAILED! Test case check create duplicate user is Failed!");
			System.out.println("====================");
		}
	}
