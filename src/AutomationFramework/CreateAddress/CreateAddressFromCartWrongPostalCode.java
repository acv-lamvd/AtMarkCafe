...
public class CreateAddressFromCartWrongPostalCode {
	public WebDriver driver;
  @Test
  public void createAddressFromCartWrongPostalCode() throws InterruptedException {
	  driver.findElement(By.className("icon-shopping-cart")).click();
		...
		driver.findElement(By.id("alias")).sendKeys("Hoang Quoc Viet");
		Thread.sleep(2000);
		...
		driver.findElement(By.id("postcode")).sendKeys("123-65676756756");
		Thread.sleep(2000);
		...
		WebElement errorPostalCode = driver.findElement(By.xpath(".//*[@id='center_column']/div/div/ul/li"));
		if(errorPostalCode.getText().equals("郵便番号は無効です。次のとおりに入力しなければなりません：000-0000")){
			System.out.println("Test case check input wrong Postal code is PASSED!");
			System.out.println("=================");
		}else{
			System.out.println("FAILED! Test case check input wrong Postal code is Failed");
			System.out.println("=================");
		}
  }
  @BeforeMethod
