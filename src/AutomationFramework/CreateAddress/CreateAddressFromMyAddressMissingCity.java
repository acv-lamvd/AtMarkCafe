...
public class CreateAddressFromMyAddressMissingCity {
	public WebDriver driver;

	@Test
	public void createAddressFromMyAddressMissingCity() throws InterruptedException {
		...
		driver.findElement(By.id("alias")).sendKeys("Cech1");
		Thread.sleep(2000);
