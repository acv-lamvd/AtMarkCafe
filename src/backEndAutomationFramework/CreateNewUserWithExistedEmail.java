...
public class CreateNewUserWithExistedEmail extends BackEndMainAction{

	protected void createNewUserWithExistedEmail() throws InterruptedException{
		...
		driver.findElement(By.id("User_Mail")).sendKeys("avctestatmark+lam2@gmail.com");
		driver.findElement(By.id("User_Name1")).sendKeys("Huong2");
