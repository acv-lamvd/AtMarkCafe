...
public class CreateNewUser extends BackEndMainAction{
	protected void createNewUser() throws InterruptedException{
		...
		bid.selectByValue("458");
		driver.findElement(By.id("User_Mail")).sendKeys("acvtestatmark+lam37@gmail.com");
		driver.findElement(By.id("User_Name1")).sendKeys("Huong1");
		driver.findElement(By.id("User_Name3")).sendKeys("Mai1");
		driver.findElement(By.id("User_Name2")).sendKeys("Van1");
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("Userdetail_Zip")));
...
//		driver.findElement(By.xpath(".//*[@id='formRegister']/div/div[3]/div[8]/input[2]")).click();
		...
		driver.findElement(By.xpath(".//*[@id='yw0']/div/input[1]")).click();
	}
