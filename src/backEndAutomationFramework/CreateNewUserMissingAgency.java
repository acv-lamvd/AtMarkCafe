...
public class CreateNewUserMissingAgency extends BackEndMainAction{
	protected void createNewUserMissingAgencty() throws InterruptedException {
		...
		driver.findElement(By.id("User_Name2")).sendKeys("Van");
...
//		driver.findElement(By.xpath(".//*[@id='formRegister']/div/div[3]/div[8]/input[2]")).click();
		System.out.println("Click Submit button OK");
	}
